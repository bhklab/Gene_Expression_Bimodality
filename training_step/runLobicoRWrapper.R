runLobicoRWrapper <- function(drugPheno,mat,K,M,cplexLibPath=NULL){



  options(warn = FALSE)
  if(is.null(cplexLibPath)){
    options(LD_LIBRARY_PATH="/mnt/work1/software/CPLEX_Studio/12.8.0/cplex/bin/x86-64_linux:/sge/lib/linux-x64")
  }
